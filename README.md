...
## Versione 0.8.3 correttiva + diagnostica

Questa versione è temporanea per diagnosticare il recupero dei dati. Scrive nel log a livello WARNING messaggi con prefisso `[0.8.3 DIAG]`, senza registrare password o token API.

Dopo il riavvio di Home Assistant, cercare `0.8.3 DIAG` nei registri dell'integrazione `nuvola`.
